...
- ¿Qué centros están pendientes por módulo, con su última fecha y localización OYM?
- ¿Cuántos centros pendientes tiene cada región/cabecera?
- ¿Qué centros tienen discrepancias de estado entre módulos?
- Evolución mensual de altas/bajas por módulo.
- Evolución mensual de emplazamientos no productivos.
